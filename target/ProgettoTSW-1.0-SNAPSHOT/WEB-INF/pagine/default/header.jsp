        ...
        <div class="logo">
            ...
            <div class="contenitore-icone " style="order: 3;">
               <a href="javascript:void(0);"  class="linkMenu"   onclick="mostraMenu()">
                ...
                <a   href="" class="icone"><i class="fas fa-shopping-cart" style="color: limegreen;font-size: 30px"></i></a>
        ...
        <div class="dropdown-content">
            <div class="row">
                <div class="colum">
                    ...
                    <a href="ServletLink?scelta=prodotti"><%=categorie.get(i).getNomeCategoria()%></a>
                    <% } %>
                   <!-- <a href="#">Link 1</a>
                    <a href="#">Link 2</a>
                    <a href="#">Link 3</a>-->
