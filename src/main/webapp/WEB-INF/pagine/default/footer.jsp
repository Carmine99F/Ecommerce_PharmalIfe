...
<div class="padre-footer">
    ...
    <div class="copyright-footer">
        Copyrights © 2020 ADPSoftware. Tutti I Diritti Riservati.<br>
        Sede legale e operativa:   Via Casa Paradiso 2/A Garbagnate Monastero (LC) Italy  info@pHarmaLiferesearch.com
    </div>
</footer>
